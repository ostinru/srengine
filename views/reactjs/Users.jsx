...
var UserEditor = React.createClass({
    ...
    render: function() {
        ...
        return (
            <Panel header={"User " + user.username} key={user._id} collapsible expanded={this.state.expanded} onClick={() => this.setState({ expanded: !this.state.expanded })}>
