...
function createFields(callback) {
    ...
    var fields = [
        ...
        {X: 2, Y: 7, BS: true, ProblemId: ids[14]},{X: 3, Y: 7},{X: 4, Y: 7},{X: 5, Y: 7},{X: 6, Y: 7},{X: 7, Y: 7},{X: 8, Y: 7},{X: 9, Y: 7},{X: 10, Y: 7},{X: 11, Y: 7},{X: 12, Y: 7},{X: 13, Y: 7},{X: 14, Y: 7, ProblemId: ids[8]},{X: 15, Y: 7},{X: 16, Y: 7},{X: 17, Y: 7},{X: 18, Y: 7},{X: 19, Y: 7, BS: true, ProblemId: ids[13]},{X: 20, Y: 7},
        {X: 2, Y: 8},{X: 3, Y: 8},{X: 4, Y: 8},{X: 5, Y: 8, ProblemId: ids[9]},{X: 6, Y: 8},{X: 7, Y: 8},{X: 8, Y: 8},{X: 10, Y: 8},{X: 11, Y: 8},{X: 12, Y: 8},{X: 13, Y: 8},{X: 14, Y: 8},{X: 15, Y: 8},{X: 16, Y: 8},{X: 17, Y: 8},{X: 18, Y: 8},{X: 19, Y: 8},{X: 20, Y: 8},
        ...
        {X: 9, Y: 11},{X: 10, Y: 11},{X: 11, Y: 11},{X: 12, Y: 11},{X: 13, Y: 11},{X: 14, Y: 11},{X: 15, Y: 11},{X: 16, Y: 11},{X: 17, Y: 11},{X: 18, Y: 11, BS: true, ProblemId: ids[12]},{X: 19, Y: 11},{X: 20, Y: 11},
